...
/* Bootstrap 5 style pagination control */
$.extend($.fn.dataTableExt.oPagination, {
  bootstrap: {
    fnInit: function (oSettings, nPaging, fnDraw) {
      var oLang = oSettings.oLanguage.oPaginate;
      ...
      $(nPaging)
        ...
        .append(
          '<ul class="pagination p-5">' +
            ...
            '<a class="page-link" href="#" tabindex="-1">&larr; ' +
            oLang.sPrevious +
            "</a></li>" +
...
$(document).ready(function () {
  $("#employees").DataTable({
    dom:
      "<'row p-0 m-0'<'col-md-6 p-2 m-0 p-0'l><'col-md-6 d-flex justify-content-end p-2'f>>" + // Top controls (length menu and filter)
      "<'overflow-auto'tr>" + // Table placed inside a div with overflow-auto class
      "<'row'<'col-md-6'i><'col-md-6'p>>", // Bottom controls (info and pagination)
    pagingType: "simple_numbers", // Bootstrap 5 pagination style
    language: {
      lengthMenu: "_MENU_ RPP",
      search: "",
